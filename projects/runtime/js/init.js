var init = function (window) {
    ...
    var background = opspark.makeBackground(app,ground);// creates a var called background and stroes the background in it
    ...
    var hud = opspark.makeHud(); // crated a var hyd and it holds the heads up display
    view.addChild(hud); // adds the background to the canvas so we can see it
    window.hud;
